...
import { fetchAdminUsers, setSuspended, type UserSummary } from '../../api/adminUserApi';
    ...
    <div className={styles.page}>
      <div className={styles.pageHeader}>
        <div>
          ...
          <p className={styles.pageSubtitle}>전체 {users.length}명</p>
        </div>
      </div>
                ...
                return (
                  ...
                  >
                    <div className={styles.listName}>
                      ...
                      {u.role === 'ADMIN' && <span className={styles.adminBadge}>관리자</span>}
                    </div>
            ...
            <div className={styles.detail}>
              ...
              <table className={styles.detailTable}>
                <tbody>
                  ...
                  <tr><th>권한</th><td>{selected.role === 'ADMIN' ? '관리자' : '일반 사용자'}</td></tr>
