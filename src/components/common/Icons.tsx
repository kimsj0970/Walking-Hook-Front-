 ...
 * 낚싯바늘.
 *
 * 좌표를 24x24 뷰박스 **가운데에 맞춰** 잡아 두었다. 예전 경로는 도형이
 * x 10.4~22 / y 1.4~17 에 걸쳐 있어 중심이 (16.2, 9.2) 였고, 원형 타일 안에
 * 넣으면 눈에 띄게 오른쪽 위로 쏠려 보였다. (-4.2, +2.8) 만큼 옮긴 값이다.
 */
export function HookIcon(p: IconProps = {}) {
  return base(
    <>
      <path d="M7.8 5.8v9a5 5 0 0 0 10 0h-3a2 2 0 0 1-4 0V5.8" />
      <circle cx="7.8" cy="5.8" r="1.6" />
    </>,
    p,
  );
}
